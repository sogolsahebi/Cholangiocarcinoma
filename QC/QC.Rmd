...
result <- data.frame(
  ...
  `Autoimmune (n=14)` = c("", summary_stats$Mean_SD[1], summary_stats$Median_IQR[1], summary_stats$Min_Max[1], "",
                          "", sex_stats[1, 1], sex_stats[2, 1], "",
                          "", location_stats[1, 1], location_stats[2, 1], location_stats[3, 1], location_stats[4, 1], "",
  ...
  `Non-Autoimmune (n=19)` = c("", summary_stats$Mean_SD[2], summary_stats$Median_IQR[2], summary_stats$Min_Max[2], "",
                              "", sex_stats[1, 2], sex_stats[2, 2], "",
                              "", location_stats[1, 2], location_stats[2, 2], location_stats[3, 2], location_stats[4, 2], "",
